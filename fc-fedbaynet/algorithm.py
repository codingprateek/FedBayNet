...
class Client:
    ...
    def kfold_cv(self, data, model, target='class', k=5, csv_filename="predictions.csv"):
        """
        ...
        - model: pgmpy BayesianModel object (network structure)
        - target: name of target variable (default 'class')
        - k: number of folds (default 5)
        - csv_filename: name of CSV to save results
        
        Returns:
        - data: DataFrame with 'predicted_class' and 'prediction_confidence' columns added
